...
int main()
{
	...
	system ("cls");     //очищает консоль 
		...
		//первый раунд 
	cout << "\t Round 1:\n" << endl;
	cout << "Игрок 1, убедитесь, что ваш соперник не видит ваших действий и введите " << max << " уникальных(неповторяющихся) букв латинского алфавита:\n" << endl;
	...
	d.clear();
		...
		//второй раунд
	cout << "\t Round 2:\n" << endl;
	cout << "Игрок 2, убедитесь, что ваш соперник не видит ваших действий и введите " << max << " уникальных(неповторяющихся) букв латинского алфавита:\n" << endl;
